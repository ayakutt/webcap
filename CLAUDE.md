...
- `safari/` - Safari Web Extension Xcode project (macOS only) generated by `xcrun safari-web-extension-converter`. Build phases reference files in `../../../extension/...` so editing the source updates both browsers.
...
### Safari
- Open `safari/Webcap/Webcap.xcodeproj`, run the `Webcap` scheme.
